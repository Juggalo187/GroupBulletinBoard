...
function GBB.InitializeAllDungeonTags()
  if not GBB.dungeonTagsLoc then
    GBB.dungeonTagsLoc = {}
  end
  
  local languages = {"enGB", "deDE", "ruRU", "frFR", "zhTW"}
  
  for _, lang in ipairs(languages) do
    if not GBB.dungeonTagsLoc[lang] then
      GBB.dungeonTagsLoc[lang] = {}
    end
    
    -- Ensure all dungeons have at least an empty array
    for i = 1, GBB.MAXDUNGEON do
      local dungeon = GBB.dungeonSort[i]
      if dungeon and not GBB.dungeonTagsLoc[lang][dungeon] then
        GBB.dungeonTagsLoc[lang][dungeon] = {}
      end
    end
  end
end
...
GBB.badTagsLoc = langSplit( {
  enGB = "layer boost guild recruit recruiting apply application apps lfmembers members",
  deDE = "fc gilde bewerbung mitglieder",
  ruRU = "гильдию гильдия слой набор вербуем вступай",
  frFR = "guilde recrutement recrute rejoindre",
  zhTW = "影布 回流 公會 招募",
} )
...
GBB.dungeonTagsLoc = {
  enGB = langSplit( {
    ...
    [ "BWL" ]    = "blackwing bwl",
    [ "AQ40" ]   = "aq40",
    [ "NAXX" ]   = "naxxramas nax naxx nax10 naxx10 nax25 naxx25 naxx10hc naxx25hc naxx10nm naxx25nm",
    [ "WSG" ]    = "wsg",
    [ "AB" ]     = "ab",
    [ "AV" ]     = "av",
    [ "EOTS" ]   = "eots",
	...
	[ "LOVE" ] = "love is in the air love romance crown chemistry",
	[ "NOBLEGARDEN" ] = "noblegarden noble garden spring eggs",
	[ "MIDSUMMER" ] = "midsummer fire festival flames",
	[ "HARVEST" ] = "harvest festival",
	[ "WINTERVEIL" ] = "winter veil feast of winter veill greatfather winter",
	[ "UK"] = "uk utgarde keep",
	[ "UP"] = "up utgarde pinnacle pinn", 
	[ "NEX"] = "nex nexus",
	[ "AN"] = "an azjol nerub",
	[ "AK"] = "ak ahnkahet old kingdom",
	[ "DTK"] = "dtk draktharon drak tharon",
	[ "VH"] = "vh violet hold",
	[ "GUN"] = "gun gundrak",
	[ "HOL"] = "hol halls stone",
	[ "HOS"] = "hos halls lightning",
	[ "COS"] = "cos culling stratholme",
	[ "OCC"] = "occ oculus",
	[ "FOS"] = "fos forge souls",
	[ "POS"] = "pos pit saron",
	[ "HOR"] = "hor halls reflection",
	[ "EOE"] = "eoe eye eternity malygos eoe10 eoe10hc eoe25 eoe25hc",
	[ "OS"] = "os obsidian sanctum sartharion os25hc os25 os10 os10hc",
	[ "VOA"] = "voa vault archavon arch voa10 voa18",
	[ "ULDUAR"] = "ulduar  uld",
	[ "TOC"] = "toc trial crusader",
	[ "TOGC"] = "togc trial grand crusader",
	[ "ICC"] = "icc icecrown citadel lich king",
	[ "RS"] = "rs ruby sanctum halion",
	[ "UK_H"] = "huk utgarde keep",
	[ "NEX_H"] = "hnex nexus",
	[ "AN_H"] = "hanan azjol nerub heroicazjol heroicnerub",
	[ "AK_H"] = "hakak ahnkahet old kingdom heroica heroickahet heroickingdom",
	[ "DTK_H"] = "hdtk dtk draktharon drak tharon heroicdtk heroictk heroickeep",
	[ "VH_H"] = "hvh vh violet hold hvh heroicvh heroicviolet",
	[ "GUN_H"] = "hgun gun gundrak heroicgun heroicgundrak",
	[ "HOL_H"] = "hhol hol lightning heroiclightning",
	[ "HOS_H"] = "hhos hos stone heroichos heroicstone",
	[ "COS_H"] = "hcos cos culling stratholme",
	[ "OCC_H"] = "hocc occ oculus",
	[ "UP_H"] = "hup up utgarde pinnacle pinn",
  ...
  deDE = langSplit( {
	...
	[ "POS"] = "pos pit saron",
	[ "HOR"] = "hor halls reflection",
	[ "EOE"] = "eoe eye eternity malygos",
	[ "OS"] = "os obsidian sanctum sartharion os25hc os25 os10 os10hc",
	[ "VOA"] = "voa vault archavon arch",
	[ "ULDUAR"] = "ulduar  uld",
	[ "TOC"] = "toc trial crusader",
	[ "TOGC"] = "togc trial grand crusader",
	[ "ICC"] = "icc icecrown citadel lich king",
  ...
  ruRU = langSplit( {
	...
	[ "HOR"] = "hor halls reflection",
	[ "EOE"] = "eoe eye eternity malygos",
	[ "OS"] = "os obsidian sanctum sartharion os25hc",
	[ "VOA"] = "voa vault archavon arch",
	[ "ULDUAR"] = "ulduar  uld",
	[ "TOC"] = "toc trial crusader",
	[ "TOGC"] = "togc trial grand crusader",
