...
GBB.locales = {
  enGB = {
	...
	["CboxFilterTradeChat"] = "Filter out trade messages (WTS/WTB)",
  ...
  deDE = {
	...
	["BtnClearList"] = "LFG-Liste löschen",
    ["BtnWho"] = "Who %s",
    ...
    ["TabGroup"] = "Mitglieder",
    ["TabRequest"] = "Anfragen",
	[ "BREW" ]   = "braufest kernbrauer unheimlicher brauer",
    [ "HOLLOW" ] = "kopfoser reiter",
	[ "LOVE" ] = "liebe liegt in der luft liebe romantik krone chemie",
	[ "NOBLEGARDEN" ] = "adelhain adliger garten frühling eier",
	[ "MIDSUMMER" ] = "sonnwendfest sonnwend feuerfest flammen",
	[ "HARVEST" ] = "erntedankfest",
	[ "WINTERVEIL" ] = "winterhauch winterhauchfest fest des winterhauchs großvater winter",
	[ "UK"] = "uk utgarde festung",
	[ "UP"] = "up utgarde spitze pinn", 
	[ "NEX"] = "nex nexus",
	[ "AN"] = "an azjol nerub",
	[ "AK"] = "ak ahnkahet altes königreich",
	[ "DTK"] = "dtk draktharon drak tharon",
	[ "VH"] = "vh violette festung",
	[ "GUN"] = "gun gundrak",
	[ "HOL"] = "hol steine hallen steinhallen",
	[ "HOS"] = "hos blitz hallen blitzehallen",
	[ "COS"] = "cos auslöschung von stratholme",
	[ "OCC"] = "occ oculus",
	[ "FOS"] = "fos schmiede der seelen",
	[ "POS"] = "pos grube von saron",
	[ "HOR"] = "hor halle der reflexion",
	[ "EOE"] = "eoe auge der ewigkeit malygos",
	[ "OS"] = "os obsidiansanktum sartharion os25hc",
	[ "VOA"] = "voa gewölbe des archavon arch",
	[ "ULDUAR"] = "ulduar  uld",
	[ "TOC"] = "toc pruefung des kreuzzüglers",
	[ "TOGC"] = "togc pruefung des obersten kreuzzüglers",
	[ "ICC"] = "icc eiskronenzitadel lichkönig",
	[ "RS"] = "rs rubinheiligtum halion",
	[ "UK_H"] = "huk utgarde festung",
	[ "NEX_H"] = "hnex nexus",
	[ "AN_H"] = "hanan azjol nerub heroischazjol heroischnerub",
	[ "AK_H"] = "hakak ahnkahet altes königreich heroischah heroischkahet heroischkoenigreich",
	[ "DTK_H"] = "hdtk dtk draktharon drak tharon heroischdtk heroischtk heroischfestung",
	[ "VH_H"] = "hvh vh violette festung hvh heroischvh heroischviolett",
	[ "GUN_H"] = "hgun gun gundrak heroischgun heroischgundrak",
	[ "HOL_H"] = "hhol hol blitz heroischblitz",
	[ "HOS_H"] = "hhos hos stein heroischhos heroischstein",
	[ "COS_H"] = "hcos cos auslöschung von stratholme",
	[ "OCC_H"] = "hocc occ oculus",
	[ "UP_H"] = "hup up utgarde spitze pinn",
  },
  esMX = {
  ...
  ruRU = {
	...
	["BtnClearList"] = "Очистить список LFG",
    ["BtnWho"] = "Кто %s",
    ["BtnWhisper"] = "Шепот %s",
	...
	["HeaderRaids"] = "Raids",
	[ "BREW" ]   = "хмельной фестиваль хмелевар яркий хмелевар",
    [ "HOLLOW" ] = "всадник без головы",
	[ "LOVE" ] = "любовь в воздухе любовь романтика корона химия",
	[ "NOBLEGARDEN" ] = "сад чудес благородный сад весна яйца",
	[ "MIDSUMMER" ] = "огненный солнцеворот праздник огня пламя",
	[ "HARVEST" ] = "праздник урожая",
	[ "WINTERVEIL" ] = "праздник зимнего покрова пир зимнего покрова великий отец зима",
	[ "UK"] = "ук крепость утгард",
	[ "UP"] = "уп вершина утгарда", 
	[ "NEX"] = "некс nexus",
	[ "AN"] = "ан азжол неруб",
	[ "AK"] = "ак анкахет древнее королевство",
	[ "DTK"] = "дтк драк тарон драк тарон",
	[ "VH"] = "вх аметистовая крепость",
	[ "GUN"] = "гун гундрак",
	[ "HOL"] = "хол чертоги камня",
	[ "HOS"] = "хос чертоги молний",
	[ "COS"] = "кос очищение стратхольма",
	[ "OCC"] = "окк окулус",
	[ "FOS"] = "фос кузня душ",
	[ "POS"] = "пос яма сарона",
	[ "HOR"] = "хор чертоги отражений",
	[ "EOE"] = "еое око вечности малигос",
	[ "OS"] = "ос обсидиановое святилище сартарион",
	[ "VOA"] = "воа склеп аркавона арх",
	[ "ULDUAR"] = "улдуар улд",
	[ "TOC"] = "ток испытание крестоносца",
	[ "TOGC"] = "токг испытание верховного крестоносца",
	[ "ICC"] = "ицк цитадель ледяной короны король лич",
	[ "RS"] = "рс рубиновое святилище халион",
	[ "UK_H"] = "хук крепость утгард",
	[ "NEX_H"] = "хнекс некс",
	[ "AN_H"] = "ханан азжол неруб героиказжол героикнеруб",
	[ "AK_H"] = "хакак анкахет древнее королевство героиках героиккахет героиккоролевство",
	[ "DTK_H"] = "хдтк дтк драк тарон драк тарон героикдтк героиктк героиккрепость",
	[ "VH_H"] = "хвх вх аметистовая крепость хвх героиквх героикаметист",
	[ "GUN_H"] = "хгун гун гундрак героикгун героикгундрак",
	[ "HOL_H"] = "ххол хол молнии героикмолнии",
	[ "HOS_H"] = "ххос хос камень героикхос героиккамень",
	[ "COS_H"] = "хкос кос очищение стратхольма",
	[ "OCC_H"] = "хокк окк окулус",
	[ "UP_H"] = "хуп уп вершина утгарда",
  },
  zhTW = {
    ...
    ["HeaderSettings"] = "設定",
    ["PanelFilter"] = "經典時代過濾",
	["WotLKPanelFilter"] = "WotLK 時代濾鏡",
    ["TBCPanelFilter"] = "TBC 時代濾鏡",
    ...
    ["AboutCreditsClassic"] = "Classic version by Vyscî-Whitemane.",
	["HeaderRaids"] = "Raids",
	[ "BREW" ]   = "啤酒節科倫烈酒可怕的黑鐵釀酒師",
    [ "HOLLOW" ] = "無頭騎士",
	[ "LOVE" ] = "愛就在空氣中愛情浪漫皇冠化學",
	[ "NOBLEGARDEN" ] = "貴族花園春天彩蛋",
	[ "MIDSUMMER" ] = "仲夏火焰節火焰",
	[ "HARVEST" ] = "收穫節",
	[ "WINTERVEIL" ] = "冬幕節冬幕盛宴冬幕爺爺",
	[ "UK"] = "uk 俄特加德要塞",
	[ "UP"] = "up 俄特加德之巔", 
	[ "NEX"] = "nex 奧核之眼",
	[ "AN"] = "an 阿茲歐奈幽",
	[ "AK"] = "ak 安卡罕特古王國",
	[ "DTK"] = "dtk 德拉克薩隆德拉克薩隆要塞",
	[ "VH"] = "vh 紫羅蘭堡",
	[ "GUN"] = "gun 剛德拉克",
	[ "HOL"] = "hol 石之大廳",
	[ "HOS"] = "hos 雷光大廳",
	...
	[ "NEX_H"] = "hnex 奧核之眼",
	[ "AN_H"] = "hanan 阿茲歐奈幽英雄",
	[ "AK_H"] = "hakak 安卡罕特古王國英雄",
	[ "DTK_H"] = "hdtk dtk 德拉克薩隆德拉克薩隆要塞英雄",
	[ "VH_H"] = "hvh vh 紫羅蘭堡英雄",
	[ "GUN_H"] = "hgun gun 剛德拉克英雄",
	[ "HOL_H"] = "hhol hol 雷光大廳英雄",
	[ "HOS_H"] = "hhos hos 石之大廳英雄",
	[ "COS_H"] = "hcos cos 斯坦索姆的抉擇",
	[ "OCC_H"] = "hocc occ 奧核之眼",
	[ "UP_H"] = "hup up 俄特加德之巔",
  },
